...
const report = {
  build: "qama-unified-final-2026-08-14.3",
  paths: {},
  pass: [],
  fail: [],
  transcripts: {},
...
try {
  ...
  const buildOk = await page.evaluate(() => (document.querySelector('meta[name="qama-build-id"]')?.content || "") === "qama-unified-final-2026-08-14.3");
